                    ...
                    <div class="col-12">
                        <div class="breadcrumb_content">
                            <ul>
                                ...
                                @foreach($category as $val)
                                    @if($val->id == $id)
                                        <li style="font-family:Lato sans-serif">Sản phẩm / Thể loại / {{$val->name}}</li>
                                    @endif
                                @endforeach
                            </ul>
                        </div>
                                        ...
                                        <div class="item-product">
                                            <div class="product-thumb">
                                                ...
                                                <div class="action-link">
                                                    <a class="quick-view same-link" href="" title="Xem nhanh" data-toggle="modal" data-target="#{{$val->id}}" data-original-title="quick view"><i class="zmdi zmdi-eye zmdi-hc-fw"></i></a>
                                            ...
                                            <div class="product-caption">
                                                ...
                                                <div class="price-box">
                                                    @if($val->sale_price >0)
                                                    <span class="regular-price">{{number_format($val->sale_price)}}</span>
                                                    <span class="old-price"><del>{{number_format($val->price)}}</del></span>
                                                    @else
                                                    <span class="regular-price">{{number_format($val->price)}}</span>
                                                    @endif
                                                </div>
                                                <div class="cart">
                                                    <div class="add-to-cart">
                                                        <a href="{{route('add-cart',$val->id)}}" title="Add to cart"><i class="zmdi zmdi-shopping-cart-plus zmdi-hc-fw"></i></a>
                                                    </div>
                                                </div>
                                            </div>
